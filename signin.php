                         ...
                         <div class="ec-login-form ">
                            ...
                            ?>
                                 ...
                                 <span class="ec-login-wrap">
                                     ...
                                     <input type="text" placeholder="Enter your email add..." id="email2" value="<?php echo $email; ?>"/>

                                 </span>
                                 <span class="ec-login-wrap">
                                     <label>Password*</label>
                                     <input type="password" placeholder="Enter your password" id="password2" value="<?php echo $password; ?>"/>
